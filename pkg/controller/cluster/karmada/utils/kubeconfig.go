...
func GenKubeConfigFromSpec(serverURL, userName, clusterName, kubeconfigName string, caCert []byte, clientKey []byte, clientCert []byte) ([]byte, error) {
	...
	if err != nil {
		return nil, errors.New("failure while serializing admin kubeconfig")
	}
