/*
Copyright 2022 Captain Authors
...
const (
	...
	ClusterGroup = "cluster.captain.io/group"

	Finalizer = "finalizer.cluster.captain.io"
)
...
type Connection struct {
	...
	//   kubeconfig and captain apiserver endpoint provided
	// ConnectionTypeProxy means using captain proxy, no kubeconfig
	//   or captain apiserver endpoint required
	Type ConnectionType `json:"type,omitempty"`

	// Captain API Server endpoint. Example: http://10.10.0.11:8080
	...
	CaptainAPIEndpoint string `json:"captainAPIEndpoint,omitempty"`
	...
	// CaptainAPIServerPort is the port which listens for forwarding captain apigateway traffic
	// Only applicable when connection type is proxy.
	CaptainAPIServerPort uint16 `json:"captainAPIServerPort,omitempty"`
}
